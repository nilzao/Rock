...
class Access_Model_Login
{
    ...
    {
        $daoUser = Access_Dbt_Dao_RockUsers::getInstance();
    ...
    private function checkActive(Access_Dbt_Ent_RockUsers $user)
    {
    ...
    private function checkEmail(Access_Dbt_Ent_RockUsers $user, $email)
    {
    ...
    private function checkPasswd(Access_Dbt_Ent_RockUsers $user, $passwd)
    {
